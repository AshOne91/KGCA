...
void ShapeLine::CreateVertexData()
{
	...
	_VertexList[0] = PNCT_VERTEX(TVector3(0.0f, 0.0f, 0.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(1.0f, 0.0f, 0.0f, 1.0f), TVector2(0.0f, 0.0f));
	_VertexList[1] = PNCT_VERTEX(TVector3(0.0f, 0.0f, 1000.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(1.0f, 0.0f, 0.0f, 1.0f), TVector2(1.0f, 0.0f));
	_InitVertexList = _VertexList;
}
...
void ShapeDirectionLine::CreateVertexData()
{
  ...
  // 앞면
	...
	_VertexList[0] = PNCT_VERTEX(TVector3(0.0f, 0.0f, 0.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(1.0f, 0.0f, 0.0f, 1.0f), TVector2(0.0f, 0.0f));
	_VertexList[1] = PNCT_VERTEX(TVector3(1.0f, 0.0f, 0.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(1.0f, 0.0f, 0.0f, 1.0f), TVector2(1.0f, 0.0f));
	_VertexList[2] = PNCT_VERTEX(TVector3(0.0f, 0.0f, 0.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(0.0f, 1.0f, 0.0f, 1.0f), TVector2(0.0f, 0.0f));
	_VertexList[3] = PNCT_VERTEX(TVector3(0.0f, 1.0f, 0.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(0.0f, 1.0f, 0.0f, 1.0f), TVector2(1.0f, 0.0f));
	_VertexList[4] = PNCT_VERTEX(TVector3(0.0f, 0.0f, 0.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(0.0f, 0.0f, 1.0f, 1.0f), TVector2(0.0f, 0.0f));
	_VertexList[5] = PNCT_VERTEX(TVector3(0.0f, 0.0f, 1.0f), TVector3(0.0f, 0.0f, -1.0f), TVector4(0.0f, 0.0f, 1.0f, 1.0f), TVector2(1.0f, 0.0f));
	_InitVertexList = _VertexList;
}
