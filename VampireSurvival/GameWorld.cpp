...
bool GameWorld::CInit()
{
    ...
    I_EventManager.GetInstance().AddListener(EventType::CreateObject, &(I_MapManager));
    ...
    I_EventManager.GetInstance().AddListener(EventType::DestroyObject, &(I_MapManager));
    ...
    I_EventManager.GetInstance().AddListener(EventType::CreateComponent, &(I_MapManager));
    ...
    I_EventManager.GetInstance().AddListener(EventType::AddComponent, &(I_MapManager));
    ...
    I_EventManager.GetInstance().AddListener(EventType::ReleaseComponent, &(I_MapManager));
    ...
    I_MapManager.CInit();
    I_UIManager.CInit();
    _pUser = I_ObjectManager.CreateObject<User2D>();
    _vCamera = _pUser->_transform.GetPosition();
    return true;
}
